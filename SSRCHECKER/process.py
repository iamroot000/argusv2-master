...
class SSRsetup():
    ...
    def ansibleHosts(self, ssrrestart=False, v2rayrestart=False):
        ...
        for ssr_host in ssr_hosts:
            ...
            if ssrrestart is True:
            ...
            elif v2rayrestart is True:



                for data in V2rayconfigsummaryModel.objects.all():



                    datamodel = SSRinitdataModel.objects.get(IP=data.IP)



                    data.IDC= datamodel.IDC
                    ...
                    open(self.hostsfile, 'a').write(
                        ...
                        '{} ansible_ssh_port={} ansible_ssh_user={} v2ray_idc={} v2ray_port={} v2ray_url_path={} v2ray_domain={}\n'.format(data.IP, ssr_port, ssr_user, data.IDC.lower(), data.V2RAY_PORT, data.V2RAY_PATH, data.V2RAY_DOMAIN))
                ...
                for data in SSRinitModel.objects.all():
                    ...
                    open(self.hostsfile, 'a').write('{} ansible_ssh_port={} ansible_ssh_user={} ansible_ssh_pass="{}" v2ray_idc={} v2ray_port={} v2ray_url_path={} v2ray_domain={}\n'.format(data.IP, data.PORT, data.USER, data.PASSWORD, data.IDC.lower(), data.V2RAY_PORT, data.V2RAY_PATH, data.V2RAY_DOMAIN))
    ...
    def ansibleExecute(self, ssrrestart=False, v2rayrestart=False):
        ...
        #limit = 'ssr_init,ssr_config,v2ray_init'
        ...
        #tags = 'initialization_ssr,config_ssr,initialization_v2ray'
        ...
        if ssrrestart is True:
            ...
            try:
                ...
                for port in V2rayconfigsummaryModel.objects.all():
            ...
            os.system(
                ...
                "ansible-playbook -i {} {} --ssh-common-args='-o StrictHostKeyChecking=no' --limit {} --tags {} --extra-vars ansible_become_pass={} --become-method=su -T 30 > {} &".format(
                    ...
                    ansiblehosts, ansible_main, limit3, tags3, ssr_password,
...
#                return 'OK'
    ...
    def ssrinfo(self, IPok, SSRerror='TIMEOUT', SSRstatus=True, SSRrestart=False):
        ...
        try:
            ...
            if SSRrestart is True:
                ...
                os.system("ansible-playbook -i {} {} --ssh-common-args='-o StrictHostKeyChecking=no' --extra-vars ansible_become_pass={} --become-method=su --limit ssr_config".format(hostsfile,restartyrm, ssr_password))
    ...
    def ssrlogs(self, username, restartssr=False, restartv2ray=False):
        ...
        elif restartv2ray is True:



            for ip in V2rayconfigsummaryModel.objects.all():



                IPS[ip.IP] = ip.V2RAY_PORT
                ...
                if "unreachable=1" in value:
                    ...
                    try:
                        ...
                        if restartssr is True:
                            ...
                            data = V2rayconfighistoryModel.objects.get(IP=key)



                            data.V2RAY_STATUS = 'UNREACHABLE'



                            data.V2RAY_LOGS = logs



                            data.V2RAY_PORT = IPS[key]



                            data.V2RAY_USERNAME = username



                            data.V2RAY_DATE = datetime.datetime.now()
                    ...
                    #     print('unreachable exception ' + str(e))
                        ...
                        if restartssr is True:
                            ...
                            V2rayconfighistoryModel.objects.create(
                    ...
                    if restartssr is True:
                        ...
                        V2rayconfigsummaryModel.objects.all().delete()
                    ...
                    v2rayinfo = v2raysave().v2rayinfo(IPok=str(key), IPIDC=IPS[key])
                    ...
                    try:
                        ...
                        if restartssr is True:
                            ...
                            idc_val = V2rayconfigsummaryModel.objects.get(IP=key)
                            ...
                            v2rayinfo = v2raysave().v2rayinfo(IPok=str(key), IPIDC=idcval)
                    ...
                    try:
                        ...
                        # SSRinitdataModel.objects.get(IP=key).delete()
                        ...
                        if restartssr is True:
                            ...
                            data.V2RAY_STATUS = v2rayinfo['V2RAY_STATUS']



                            data.V2RAY_PORT = v2rayinfo['V2RAY_PORT']



                            data.V2RAY_DOMAIN = v2rayinfo['V2RAY_DOMAIN']



                            data.V2RAY_PATH = v2rayinfo['V2RAY_PATH']



                            data.V2RAY_URL = v2rayinfo['V2RAY_URL']
                    ...
                    #     print('success 2 exception ' + str(e))
                        ...
                        if restartssr is True:
                            ...
                            SSRinitdataModel.objects.create(
                                ...
                                V2RAY_STATUS=v2rayinfo['V2RAY_STATUS'],



                                V2RAY_PORT=v2rayinfo['V2RAY_PORT'],



                                V2RAY_DOMAIN=v2rayinfo['V2RAY_DOMAIN'],



                                V2RAY_PATH=v2rayinfo['V2RAY_PATH'],



                                V2RAY_URL=v2rayinfo['V2RAY_URL'],
    ...
    def ssrping(self, IPadd):
        ...
        if response == 0:
            ...
            try:
                ...
                ssh.connect('{}'.format(IPadd), username=ssr_user, port=ssr_port, timeout=15)
